...
=======
    LEFT OUTER JOIN TBL_CROSSTALK_PACKET CTP ON T.CT_ENTRY_ID=CTP.ENTRY_ID
    LEFT OUTER JOIN TBL_CUSTOMER_VEHICLE CV_CTP ON CTP.FIRST_READ =CV_CTP.TAG_ID
>>>>>>> 7a05172c2c1f46596753c9406082f3ffa1e1e336
    LEFT OUTER JOIN TBL_VEHICLE_CLASS VC_CTP ON CV_CTP.VEHICLE_CLASS_ID =VC_CTP.VEHICLE_CLASS_ID
