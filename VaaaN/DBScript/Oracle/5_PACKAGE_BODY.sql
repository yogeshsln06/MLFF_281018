/* Formatted on 20/12/2018 13:59:06 (QP5 v5.215.12089.38647) */
...
AS
   ...
   BEGIN
      UPDATE TBL_TRANSACTION
         SET NF_ENTRY_ID_FRONT = P_NF_ENTRY_ID_FRONT, LANE_ID = P_LANE_ID
   ...
   BEGIN
      UPDATE TBL_TRANSACTION
         SET NF_ENTRY_ID_REAR = P_NF_ENTRY_ID_REAR, LANE_ID = P_LANE_ID
       WHERE     TMS_ID = P_TMS_ID
             AND PLAZA_ID = P_PLAZA_ID
             AND LANE_ID = P_LANE_ID
             AND TRANSACTION_ID = P_TRANSACTION_ID;
...
ORDER BY TRANSACTION_ID DESC';
  ...
  FROM TRANS_UNREVIEWED T
       ...
       LEFT OUTER JOIN TBL_CUSTOMER_VEHICLE CV_CTP
          ON CTP.OBJECT_ID = CV_CTP.TAG_ID
       LEFT OUTER JOIN TBL_VEHICLE_CLASS VC_CTP
          ON VC_CTP.VEHICLE_CLASS_ID = CV_CTP.VEHICLE_CLASS_ID
