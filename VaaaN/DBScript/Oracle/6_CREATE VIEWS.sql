/* Formatted on 15-02-2019 15:07:52 (QP5 v5.215.12089.38647) */
...
AS
   SELECT SC.ENTRY_ID,
    ...
    WHERE     SC.MESSAGE_DIRECTION = 2
          ...
          AND NVL (CV.VEHICLE_RC_NO, '-999') <> '-999';
...
AS
   SELECT T.TMS_ID,
          ...
          T.TRANSACTION_DATETIME,
          T.CREATION_DATE,
          SH.CREATION_DATE SMS_CREATION,
          SH.MESSAGE_SEND_TIME,
          SH.MESSAGE_RECEIVE_TIME,
          ROUND ( (SH.MESSAGE_RECEIVE_TIME - T.CREATION_DATE) * 24 * 60 * 60,
                 0)
             AS SECONDS
     FROM TBL_TRANSACTION T
          LEFT OUTER JOIN TBL_PLAZA P
