/* Formatted on 2/5/2019 5:52:32 PM (QP5 v5.215.12089.38647) */
...
AS
   SELECT T.TMS_ID,
          ...
          T.TRANSACTION_DATETIME,
          T.CREATION_DATE,
          T.CT_ENTRY_ID AS CT_FRONT_ID,
		  CTP.TIME_STAMP AS CT_FRONT_TIMESTAMP,
          CTP.OBJECT_ID AS CT_FRONT_TAG_ID,
          CTP.CTP.VEHICLE_CLASS_ID AS CT_FRONT_CLASS_ID,
          CTP.PLATE_NUMBER AS CT_FRONT_VRN,
		  
          T.CT_ENTRY_ID_REAR AS CT_REAR_ID,
		  CTPR.TIME_STAMP AS CT_REAR_TIMESTAMP,
          CTPR.OBJECT_ID AS CT_REAR_TAG_ID,
          CTPR.VEHICLE_CLASS_ID AS CT_REAR_CLASS_ID,
          ...
          NFPR.VEHICLE_SPEED AS REAR_SPEED,
          T.IS_BALANCE_UPDATED,
          T.IS_TRANSFERED,
          T.IS_VIOLATION,
          T.IS_REGISTERED,
