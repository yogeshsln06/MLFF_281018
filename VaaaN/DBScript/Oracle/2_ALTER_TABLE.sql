...
--One Time Use
--DROP TABLE TBL_ETC_TRAN;
--DROP TABLE TBL_REG_LOCATION;
--DROP SEQUENCE CUSTOMER_APPOINTMENT_SEQ;
--DROP TABLE TBL_CUSTOMER_APPOINTMENT;
--DROP SEQUENCE CUSTOMER_QUEUE;
--DROP TABLE TBL_CUSTOMER_QUEUE;