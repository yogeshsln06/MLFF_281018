...
namespace VaaaN.MLFF.VehicleFlowSimulator
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private string CreateFrontPacket(DateTime transactionTime, string vrn)
        {
            string result = string.Empty;
            try
            {
                ...
                result = "{ " +
                          ...
                          "\"Data\": { " +
                            "\"Plate\": \"" + vrn + "\", " +
                            "\"Vehicle_Type\": \"" + GetVehicleClassNameByVRN(vrn) + "\", " +
                            "\"Vehicle_Speed\": 0, " +
        ...
        private string CreateRearPacket(DateTime transactionTime, string vrn)
        {
            string result = string.Empty;
            try
            {
    ...
    public class MLFFSimulator
    {
        ...
        private void SendANPRPacket(ANPRPacket rdp)
        {
            ...
            HttpClient client = new HttpClient();
            string url = this.apiIPAddress + "/VaaaN/IndonesiaMLFFApi/SendNodefluxEvent";
            client.BaseAddress = new Uri(url);
